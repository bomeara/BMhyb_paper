...
results.cichlid.no.measurement.error <- BMhyb(data.log, phy, flow, store.sims=TRUE, measurement.error=0)
results.cichlid <- BMhyb(data.log, phy, flow, store.sims=TRUE)

save(results.cichlid, results.cichlid.no.measurement.error, phy, flow, data.log, file="CichlidResults.RSave")
