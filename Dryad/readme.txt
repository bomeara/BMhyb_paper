Attached files contains scripts and analyses we used for the paper, as used (i.e., they may have hardcoded paths to files; these paths may have to be modified). They are organized into three directories:

DataResults: the data, code and results for the empirical analyses.

FigureAndTable: the code used to make the plots and tables in the paper.
