setwd("/Users/bomeara/Dropbox/CollabJhwuengOMeara/ReReSubmission/Cichlid")
library(BMhyd)
library(geiger)
library(ape)
#library(optimx)
...
setwd("/Users/bomeara/Dropbox/CollabJhwuengOMeara/ReReSubmission/FiguresAndTables")
...
padding.factor = 2
length.factor = 0.07
PlotNetwork(phy.cichlid, flow.cichlid, name.padding=1.5, cex=0.5, head.length=length.factor, col.donor="black", main="Cichlid")
